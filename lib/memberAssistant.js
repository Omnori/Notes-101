...
async function askGroundedAssistant({
    ...
    const SYSTEM_PROMPT = `You are Soren AI Assistant, dedicated to this Discord server and strictly grounded in the server's Notion Wiki, meeting history, and member records.
