...
async function transcribePcm16kMono(pcmBuffer, customApiKey = null) {
...
async function summarizeTranscriptWithGroq(transcriptText, customApiKey = null, customModel = null) {
    const apiKey = customApiKey || process.env.GROQ_API_KEY;
    if (!apiKey) {
        throw new Error('Groq API key is not configured for this server.');
    }
