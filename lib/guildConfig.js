...
function setGuildKeys(guildId, { groqApiKey, geminiApiKey, summaryProvider, groqModel, geminiModel }) {
    ...
    if (groqModel !== undefined) guildConfigs[guildId].groqModel = groqModel;
    if (geminiModel !== undefined) guildConfigs[guildId].geminiModel = geminiModel;
    saveConfigs();
}
...
function clearGuildKeys(guildId) {
    if (guildConfigs[guildId]) {
        ...
        delete guildConfigs[guildId].groqModel;
        delete guildConfigs[guildId].geminiModel;
